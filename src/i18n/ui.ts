...
export const UI: Record<Locale, Dict> = {
  de: {
    ...
    'cta.securePaymentTwint': 'Sicher bezahlen mit Karte oder TWINT',
  ...
  en: {
    ...
    'cta.securePaymentTwint': 'Pay securely by card or TWINT',
  ...
  it: {
    ...
    'cta.securePaymentTwint': 'Paga in modo sicuro con carta o TWINT',
  ...
  fr: {
    ...
    'cta.securePaymentTwint': 'Payez en toute sécurité par carte ou TWINT',
    'cta.buy': 'Souscrire',
