  ...
  },
  {
    ...
    features: {
      de: [
        ...
        'Systemintegration und tägliches Reporting',
      ],
      en: [
        ...
        'System integration and daily reporting',
      ],
      it: [
        ...
        'Integrazione di sistema e reportistica giornaliera',
      ],
      fr: [
        ...
        'Intégration système et reporting quotidien',
      ],
    },
    disclosures: {
      de: ['Keine Setup-Gebühr', '12-Monatsvertrag'],
