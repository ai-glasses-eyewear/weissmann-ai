...
export const PACKAGES: PricingPackage[] = [
  // ───────────────────────── AI Phone Agent (preserved) ─────────────────────
  {
    ...
    isFrom: false,
    description: {
      de: 'Ideal für kleine und mittlere Unternehmen ohne Systemintegrationen. Keine Setup-Gebühr, keine Mindestvertragslaufzeit – jederzeit kündbar.',
      en: 'Ideal for small and medium-sized businesses that don’t need system integrations. No setup fee, no minimum contract term – cancel any time.',
      it: 'Ideale per piccole e medie imprese senza necessità di integrazioni di sistema. Nessun costo di attivazione, nessuna durata contrattuale minima – disdicibile in qualsiasi momento.',
      fr: 'Idéal pour les petites et moyennes entreprises sans besoin d’intégrations système. Sans frais d’installation, sans durée d’engagement minimale – résiliable à tout moment.',
    },
    features: {
      de: [
    ...
    disclosures: {
      de: ['Keine Setup-Gebühr', 'Keine Mindestvertragslaufzeit – jederzeit kündbar', 'Keine Systemintegrationen enthalten'],
      en: ['No setup fee', 'No minimum contract term – cancel any time', 'No system integrations included'],
      it: ['Nessun costo di attivazione', 'Nessuna durata contrattuale minima – disdicibile in qualsiasi momento', 'Nessuna integrazione di sistema inclusa'],
      fr: ['Sans frais d’installation', 'Sans durée d’engagement minimale – résiliable à tout moment', 'Aucune intégration système incluse'],
    },
  ...
  },
  {
    ...
    isFrom: false,
    description: {
      de: 'Ideal für wachsende Unternehmen. Volle Systemintegration und tägliches Reporting. Keine Setup-Gebühr, Mindestvertragslaufzeit 12 Monate.',
      en: 'Ideal for growing businesses. Full system integration and daily reporting. No setup fee, 12-month minimum term.',
      it: 'Ideale per aziende in crescita. Integrazione di sistema completa e reportistica giornaliera. Nessun costo di attivazione, durata minima di 12 mesi.',
      fr: 'Idéal pour les entreprises en croissance. Intégration système complète et reporting quotidien. Sans frais d’installation, durée minimale de 12 mois.',
    },
    features: {
      de: [
        'Alles aus dem Starter-Paket – plus:',
        '2 Sprachen inklusive statt 1 (DE/EN/FR/IT wählbar)',
        'Verwaltung von Terminen und Kundenanfragen, automatische Auskunft zu Angeboten und Services',
        '3500 Minuten pro Monat statt 1500 – danach CHF 0.25 statt CHF 0.30 pro Minute',
        'Volle Systemintegration und tägliches Reporting',
      ],
      en: [
        'Everything in Starter – plus:',
        '2 languages included instead of 1 (choose DE/EN/FR/IT)',
        'Management of appointments and customer inquiries, plus automatic information about offers and services',
        '3,500 minutes per month instead of 1,500 – then CHF 0.25 instead of CHF 0.30 per minute',
        'Full system integration and daily reporting',
      ],
      it: [
        'Tutto del pacchetto Starter – più:',
        '2 lingue incluse invece di 1 (a scelta tra DE/EN/FR/IT)',
        'Gestione di appuntamenti e richieste dei clienti, con informazioni automatiche su offerte e servizi',
        '3500 minuti al mese invece di 1500 – poi CHF 0.25 invece di CHF 0.30 al minuto',
        'Integrazione di sistema completa e reportistica giornaliera',
      ],
      fr: [
        'Tout le pack Starter – plus :',
        '2 langues incluses au lieu d’1 (au choix : DE/EN/FR/IT)',
        'Gestion des rendez-vous et des demandes clients, avec informations automatiques sur vos offres et services',
        '3500 minutes par mois au lieu de 1500 – puis CHF 0.25 au lieu de CHF 0.30 par minute',
        'Intégration système complète et reporting quotidien',
      ],
    },
    disclosures: {
      de: ['Keine Setup-Gebühr', 'Volle Systemintegrationen inklusive', 'Mindestvertragslaufzeit 12 Monate', 'Kündigung mindestens einen Monat vor dem Verlängerungsdatum'],
      en: ['No setup fee', 'Full system integrations included', '12-month minimum contract term', 'Cancellation at least one month before the renewal date'],
      it: ['Nessun costo di attivazione', 'Integrazioni di sistema complete incluse', 'Durata contrattuale minima di 12 mesi', 'Disdetta almeno un mese prima della data di rinnovo'],
      fr: ['Sans frais d’installation', 'Intégrations système complètes incluses', 'Durée d’engagement minimale de 12 mois', 'Résiliation au moins un mois avant la date de renouvellement'],
    },
  ...
  },
  {
    ...
    isFrom: false,
    description: {
      de: 'Maximale Leistung für anspruchsvolle Unternehmen: Mehrsprachigkeit, Voice-Cloning, intelligentes Routing, Prioritätssupport und volle Systemintegrationen.',
      en: 'Maximum power for demanding businesses: multilingual support, voice cloning, smart routing, priority support and full system integrations.',
      it: 'Massime prestazioni per aziende esigenti: multilingue, voice cloning, routing intelligente, supporto prioritario e integrazioni di sistema complete.',
      fr: 'Performance maximale pour les entreprises exigeantes : multilingue, clonage vocal, routage intelligent, support prioritaire et intégrations système complètes.',
    },
    features: {
      de: [
    ...
    disclosures: {
      de: ['Preis auf Anfrage – individuelles Angebot', 'Volle Systemintegrationen inklusive', 'Mindestvertragslaufzeit 12 Monate', 'Kündigung mindestens einen Monat vor dem Verlängerungsdatum'],
      en: ['Price on request – custom proposal', 'Full system integrations included', '12-month minimum contract term', 'Cancellation at least one month before the renewal date'],
      it: ['Prezzo su richiesta – offerta personalizzata', 'Integrazioni di sistema complete incluse', 'Durata contrattuale minima di 12 mesi', 'Disdetta almeno un mese prima della data di rinnovo'],
      fr: ['Prix sur demande – offre personnalisée', 'Intégrations système complètes incluses', 'Durée d’engagement minimale de 12 mois', 'Résiliation au moins un mois avant la date de renouvellement'],
    },
    stripeLink: null,
    ctaType: 'consult',
    schemaOffer: false,
