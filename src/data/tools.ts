...
export const TOOLS: ToolDef[] = [
  // ───────────────────────────── DE · Web / Kosten ─────────────────────────────
  {
    ...
    embedH: 1500,
    meta: { title: 'Website-Kosten-Rechner Schweiz · Weissmann', description: 'Kostenloser Rechner: Wählen Sie die Bausteine Ihres Website-Projekts und sehen Sie transparente CHF-Orientierungsbänder – ohne erfundene Pauschalzahl.' },
  ...
  },
  {
    ...
    embedH: 1400,
    meta: { title: 'Starter-Website CHF 880: Eignungscheck · Weissmann', description: 'Eine kurze Anforderungs-Checkliste ordnet Ihr Website-Projekt ein: Starter (CHF 880/2’490), Business oder individuell – mit dem exakten Starter-Umfang.' },
  ...
  },
  {
    ...
    embedH: 1500,
    meta: { title: 'KI-Telefonassistent: Break-Even-Rechner · Weissmann', description: 'Drei eigene Zahlen – Anrufe pro Woche, Anteil verpasst, Wert pro Anruf – ergeben Ihren geretteten Umsatz pro Monat und den Break-Even gegenüber CHF 350.' },
  ...
  },
  {
    ...
    embedH: 1450,
    meta: { title: 'Website-Plattform-Finder für KMU · Weissmann', description: 'Beschreiben Sie Ihre Anforderungen und sehen Sie, welche Plattform passt – Wix, WordPress, Webflow oder individuell. Keine beste Plattform, nur Passung.' },
  ...
  // ───────────────────────────── EN · Web / Ads ─────────────────────────────
  {
    ...
    embedH: 1550,
    meta: { title: 'Swiss Website Quote Normaliser · Weissmann', description: 'Put two website quotes on the same scope sheet, normalise net vs gross VAT, and finally compare them like-for-like — with follow-up questions per provider.' },
  ...
  },
  {
    ...
    embedH: 1500,
    meta: { title: 'Swiss Google Ads Budget Planner · Weissmann', description: 'Pick a budget tier and see what that CHF range realistically buys as a clicks-to-enquiries funnel — using the honest Swiss ranges, plus the agency-fee layer.' },
  ...
  },
  {
    ...
    embedH: 1600,
    meta: { title: 'Multilingual URL & hreflang Planner · Weissmann', description: 'Pick your languages and markets, get a recommended URL structure and a copyable, reciprocal hreflang + canonical head block — plus the pitfalls that break it.' },
  ...
  },
  {
    ...
    embedH: 1450,
    meta: { title: 'AI-receptionist buyer persona matcher · Weissmann', description: 'Answer five priority questions to find which of the four AI-receptionist buyer personas you are — and what to prioritise, ask, and watch out for.' },
  ...
  // ───────────────────────────── IT · Ticino ─────────────────────────────
  {
    ...
    embedH: 1550,
    meta: { title: 'Calcolatore costo sito web (Svizzera) · Weissmann', description: 'Assegnate ogni voce di costo del sito a «al lancio» o «ogni anno», inserite i vostri importi e vedete il totale del primo anno vs gli anni successivi.' },
